...
def get_argparser():
    ...
    parser.add_argument("--print", action='store_true', default=False,
                        help="use print in place of logging.info")
    ...
    parser.add_argument("--model", type=str, default="deeplabv3",
                        choices=['bisenetv2', 'deeplabv3', 'deeplabv2', 'none'], help='model type; network head if deeplab')
    ...
    parser.add_argument("--output_aux", action='store_true', default=False,
                        help='bisenet v2 option to output all the intermediate feats of the segmentation branch')
