...
class Cityscapes(data.Dataset):
    ...
    def __init__(self, root, train=True, transform=None, cl19=False, target_transform=None, test_bisenetv2=False):
    ...
    def __getitem__(self, index):
        ...
        if self.test_bisenetv2:
            return (Compose(self.transform.transforms[1:])(original), img), target
        return img, target
