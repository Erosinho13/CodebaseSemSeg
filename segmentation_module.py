...
import models
from modules import DeeplabV3, DeeplabV2, BiSeNetV2
...
def make_model(opts):
    ...
    if not opts.no_pretrained:
        if opts.model != 'bisenetv2':
            ...
            pretrained_path = 'pretrained/bisenetv2.pth.tar' ##TO-DO
